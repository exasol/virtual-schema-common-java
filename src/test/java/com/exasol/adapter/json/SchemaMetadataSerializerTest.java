...
class SchemaMetadataSerializerTest {
    ...
    void serializeMetadataWithTables() {
        final ColumnMetadata columnMetadata1 = new ColumnMetadata("columnName1", "columnNotes1",
                DataType.createDouble(), true, true, "default1", "commentCol1");
        final ColumnMetadata columnMetadata2 = new ColumnMetadata("columnName2", "columnNotes2", DataType.createBool(),
                false, false, "default2", "commentCol2");
