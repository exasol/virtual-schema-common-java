...
class SchemaMetadataSerializerTest {
    ...
    void serializeMetadataWithTables() {
        final ColumnMetadata columnMetadata1 = ColumnMetadata.builder().name("columnName1").adapterNotes("columnNotes1")
                .type(DataType.createDouble()).nullable(true).identity(true).defaultValue("default1")
                .comment("commentCol1").build();
        final ColumnMetadata columnMetadata2 = ColumnMetadata.builder().name("columnName2").adapterNotes("columnNotes2")
                .type(DataType.createBool()).nullable(false).identity(false).defaultValue("default2")
                .comment("commentCol2").build();
        ...
        final TableMetadata tableMetadata1 = new TableMetadata("tableName1", "tableNotes1", firstTableColumns,
                "comment1");
        final TableMetadata tableMetadata2 = new TableMetadata("tableName2", "tableNotes2", secondTableColumns,
                "comment2");
