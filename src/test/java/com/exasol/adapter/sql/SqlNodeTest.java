...
class SqlNodeTest {
    ...
    private SqlNode getTestSqlNode() {
        ...
        final SqlExpressionList groupBy =
              new SqlGroupBy(ImmutableList.of(new SqlColumn(0, clicksMeta.getColumns().get(0))));
        ...
        final SqlOrderBy orderBy =
              new SqlOrderBy(ImmutableList.of(new SqlColumn(0, clicksMeta.getColumns().get(0))), ImmutableList.of(true),
