...
/**
 * This class is the main entry point for calls to a Virtual Schema. From here
 * the adapter calls are dispatched to the responsible adapter.
 */
public final class RequestDispatcher {
    ...
    /**
     * Main entry point for all Virtual Schema Adapter requests issued by the Exasol
     * database.
     *
     * @param metadata   metadata for the context in which the adapter exists (e.g.
     *                   the schema into which it is installed)
