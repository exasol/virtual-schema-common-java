...
public enum AggregateFunctionCapability {
     ...
     */
    COUNT_DISTINCT(AggregateFunction.COUNT), SUM, SUM_DISTINCT(AggregateFunction.SUM), MIN, MAX, AVG,
    AVG_DISTINCT(AggregateFunction.AVG), MEDIAN, FIRST_VALUE, LAST_VALUE, STDDEV,
    STDDEV_DISTINCT(AggregateFunction.STDDEV), STDDEV_POP, STDDEV_POP_DISTINCT(AggregateFunction.STDDEV_POP),
    STDDEV_SAMP, STDDEV_SAMP_DISTINCT(AggregateFunction.STDDEV_SAMP), VARIANCE,
    VARIANCE_DISTINCT(AggregateFunction.VARIANCE), VAR_POP, VAR_POP_DISTINCT(AggregateFunction.VAR_POP), VAR_SAMP,
    ...
    GEO_INTERSECTION_AGGREGATE, GEO_UNION_AGGREGATE, ST_INTERSECTION, ST_UNION, APPROXIMATE_COUNT_DISTINCT, MUL,
